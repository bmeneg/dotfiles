(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode rtags perlbrew rainbow-delimiters paredit cider clojure-ts-mode clojure-mode eglot company-c-headers ggtag ggtags clang-format smex dired-icon markdown-mode powerline use-package python-mode projectile magit helm flycheck evil-visual-mark-mode editorconfig))
