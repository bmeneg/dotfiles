...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode company ac-slime helm-slime slime xcscope markdown-mode powerline use-package python-mode projectile magit helm flycheck evil-visual-mark-mode editorconfig))))
(custom-set-faces
